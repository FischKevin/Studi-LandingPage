  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Section Newsletter */}
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, maxWidth: '400px' }}>
          <Box sx={{ backgroundColor: 'rgba(255, 255, 255, 0.2)', borderRadius: '10px', padding: '10px 20px', textAlign: 'center' }}>
            <Typography variant="h6" sx={{ fontFamily: 'Roboto', color: 'white', textShadow:'0px 8px 10px rgba(0, 0, 0, 0.4)' }}>
