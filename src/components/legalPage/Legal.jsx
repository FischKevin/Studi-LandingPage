  ...
  return (
    ...
    >
      ...
      <Typography paragraph>
        ...
        <br />
        Le site studi-pressstarttofightcancer.netlify.app est édité par Kevin
        Fischer.
        <br />
      ...
      <Typography paragraph>
        ...
        <br />
        L’utilisation du site studi-pressstarttofightcancer.netlify.app implique
        ...
        studi-pressstarttofightcancer.netlify.app sont donc invités à les
        ...
        être toutefois décidée par studi-pressstarttofightcancer.netlify.app,
      ...
      <Typography paragraph>
        ...
        <br />
        Le site studi-pressstarttofightcancer.netlify.app constitue une œuvre de
        l’esprit protégée par les dispositions du Code de la Propriété
        Intellectuelle et des Réglementations Internationales applicables. Kevin
        Fischer est propriétaire de tous les droits de propriété intellectuelle
        ...
        pour son propre compte tout ou partie des éléments ou travaux du site
        studi-pressstarttofightcancer.netlify.app. Toute utilisation,
        reproduction, représentation, totale ou partielle, sous quelque forme et
      ...
      <Typography paragraph>
        <strong>4 – Description des services fournis</strong>
        <br />
        ...
        studi-pressstarttofightcancer.netlify.app sont données à titre
        indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
        renseignements figurant sur le site
        studi-pressstarttofightcancer.netlify.app ne sont pas exhaustifs. Ils
      ...
      <Typography paragraph>
        ...
        indiquées au point 5, soit de l’apparition d’un bug ou d’une
        incompatibilité.
      </Typography>

      <Typography paragraph>
        <strong>7 – CNIL et gestion des données personnelles</strong>
        <br />
        ...
        personnelles vous concernant. Cependant, il est possible que le site
        sollicite parfois ces informations, notamment pour vous inscrire à
        l’évènement.
        <br />
        <br />
      ...
      <Typography paragraph>
        ...
        <br />
        Le site studi-pressstarttofightcancer.netlify.app contient des liens
        hypertextes vers d’autres sites et dégage toute responsabilité à propos
        de ces liens externes ou des liens créés par d’autres sites vers
        studi-pressstarttofightcancer.netlify.app.
        <br />
        <br />
        Par ailleurs, la navigation sur le site
        studi-pressstarttofightcancer.netlify.app est susceptible de provoquer
        l’installation de cookie(s) sur l’ordinateur de l’utilisateur. Vous
        trouverez l’ensemble des informations utiles à ce sujet (définition du «
        cookie », type de cookies utilisés, finalité, destinataires, droits dont
        vous disposez conformément à la réglementation applicable…) dans la
        Politique de de gestion des cookies.
      </Typography>
    </Container>
  );
}
